    ...
    public sealed class MailgunEmailSender : IEmailSender
    {
        ...
        public async Task<ResultValue<string>> SendEmail(IEmailMessage email)
        {
            ...
            try
            {
                ...
                content.Add(new StringContent(email.To.ToString()), "to");
                ...
                {
                    // Mailgun API requires the html field.
                    content.Add(new StringContent(EncodeAsHtml(email.TextBody!)), "html");
                }
                ...
                if (email.CC.Any())
                {
                    content.Add(new StringContent(email.CC.ToString()), "cc");
                }

                if (email.BCC.Any())
                {
                    content.Add(new StringContent(email.BCC.ToString()), "bcc");
                }
